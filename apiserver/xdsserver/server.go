...
import (
	...
	cluster "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/config/cluster/v3"
	"github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/config/core/v3"
	core "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/config/core/v3"
	endpoint "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/config/endpoint/v3"
	listener "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/config/listener/v3"
	route "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/config/route/v3"
	hcm "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/extensions/filters/network/http_connection_manager/v3"
	tcp "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/extensions/filters/network/tcp_proxy/v3"
	clusterservice "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/cluster/v3"
	discoverygrpc "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/discovery/v3"
	endpointservice "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/endpoint/v3"
	listenerservice "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/listener/v3"
	routeservice "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/route/v3"
	runtimeservice "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/runtime/v3"
	secretservice "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/envoy/service/secret/v3"
	"github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/pkg/cache/types"
	cachev3 "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/pkg/cache/v3"
	"github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/pkg/resource/v3"
	serverv3 "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/pkg/server/v3"
	testv3 "github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/pkg/test/v3"
	"github.com/polarismesh/polaris-server/apiserver/xdsserver/go-control-plane/pkg/wellknown"
...
func (x *XDSServer) Stop() {
	connlimit.RemoteLimitListener(x.GetProtocol())
	if x.server != nil {
		x.server.Stop()
	}
}
