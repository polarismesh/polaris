...
func (AliasType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{0}
}
...
func (HealthCheck_HealthCheckType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{4, 0}
}
...
func (*Service) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{1}
}
...
func (*ServiceAlias) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{2}
}
...
func (*Instance) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{3}
}
...
func (*HealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{4}
}
...
func (*HeartbeatHealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_35d3f18d0609d97d, []int{5}
}
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_35d3f18d0609d97d) }

var fileDescriptor_service_35d3f18d0609d97d = []byte{
	...
	,
}
