...
func (svr *Server) AppendServiceContractInterfaces(ctx context.Context, contract *service_manage.ServiceContract, source service_manage.InterfaceDescriptor_Source) *service_manage.Response {
...
func (svr *Server) CreateCircuitBreakerRules(ctx context.Context, request []*fault_tolerance.CircuitBreakerRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateCircuitBreakerRules(ctx, request)
}

// CreateCircuitBreakerVersions implements service.DiscoverServer.
func (svr *Server) CreateCircuitBreakerVersions(ctx context.Context, req []*fault_tolerance.CircuitBreaker) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateCircuitBreakerVersions(ctx, req)
}

// CreateCircuitBreakers implements service.DiscoverServer.
func (svr *Server) CreateCircuitBreakers(ctx context.Context, req []*fault_tolerance.CircuitBreaker) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateCircuitBreakers(ctx, req)
}

// CreateFaultDetectRules implements service.DiscoverServer.
func (svr *Server) CreateFaultDetectRules(ctx context.Context, request []*fault_tolerance.FaultDetectRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateFaultDetectRules(ctx, request)
}

// CreateInstances implements service.DiscoverServer.
func (svr *Server) CreateInstances(ctx context.Context, reqs []*service_manage.Instance) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateInstances(ctx, reqs)
}

// CreateRateLimits implements service.DiscoverServer.
func (svr *Server) CreateRateLimits(ctx context.Context, request []*traffic_manage.Rule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateRateLimits(ctx, request)
}

// CreateRoutingConfigs implements service.DiscoverServer.
func (svr *Server) CreateRoutingConfigs(ctx context.Context, req []*traffic_manage.Routing) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateRoutingConfigs(ctx, req)
}

// CreateRoutingConfigsV2 implements service.DiscoverServer.
func (svr *Server) CreateRoutingConfigsV2(ctx context.Context, req []*traffic_manage.RouteRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateRoutingConfigsV2(ctx, req)
}

// CreateServiceAlias implements service.DiscoverServer.
func (svr *Server) CreateServiceAlias(ctx context.Context, req *service_manage.ServiceAlias) *service_manage.Response {
	return svr.nextSvr.CreateServiceAlias(ctx, req)
}

// CreateServiceContractInterfaces implements service.DiscoverServer.
func (svr *Server) CreateServiceContractInterfaces(ctx context.Context, contract *service_manage.ServiceContract, source service_manage.InterfaceDescriptor_Source) *service_manage.Response {
...
func (svr *Server) CreateServiceContracts(ctx context.Context, req []*service_manage.ServiceContract) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateServiceContracts(ctx, req)
}

// CreateServices implements service.DiscoverServer.
func (svr *Server) CreateServices(ctx context.Context, req []*service_manage.Service) *service_manage.BatchWriteResponse {
	return svr.nextSvr.CreateServices(ctx, req)
}

// DeleteCircuitBreakerRules implements service.DiscoverServer.
func (svr *Server) DeleteCircuitBreakerRules(ctx context.Context, request []*fault_tolerance.CircuitBreakerRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteCircuitBreakerRules(ctx, request)
}

// DeleteCircuitBreakers implements service.DiscoverServer.
func (svr *Server) DeleteCircuitBreakers(ctx context.Context, req []*fault_tolerance.CircuitBreaker) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteCircuitBreakers(ctx, req)
}

// DeleteFaultDetectRules implements service.DiscoverServer.
func (svr *Server) DeleteFaultDetectRules(ctx context.Context, request []*fault_tolerance.FaultDetectRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteFaultDetectRules(ctx, request)
}

// DeleteInstances implements service.DiscoverServer.
func (svr *Server) DeleteInstances(ctx context.Context, req []*service_manage.Instance) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteInstances(ctx, req)
}

// DeleteInstancesByHost implements service.DiscoverServer.
func (svr *Server) DeleteInstancesByHost(ctx context.Context, req []*service_manage.Instance) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteInstancesByHost(ctx, req)
}

// DeleteRateLimits implements service.DiscoverServer.
func (svr *Server) DeleteRateLimits(ctx context.Context, request []*traffic_manage.Rule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteRateLimits(ctx, request)
}

// DeleteRoutingConfigs implements service.DiscoverServer.
func (svr *Server) DeleteRoutingConfigs(ctx context.Context, req []*traffic_manage.Routing) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteRoutingConfigs(ctx, req)
}

// DeleteRoutingConfigsV2 implements service.DiscoverServer.
func (svr *Server) DeleteRoutingConfigsV2(ctx context.Context, req []*traffic_manage.RouteRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteRoutingConfigsV2(ctx, req)
}

// DeleteServiceAliases implements service.DiscoverServer.
func (svr *Server) DeleteServiceAliases(ctx context.Context, req []*service_manage.ServiceAlias) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteServiceAliases(ctx, req)
}

// DeleteServiceContractInterfaces implements service.DiscoverServer.
func (svr *Server) DeleteServiceContractInterfaces(ctx context.Context, contract *service_manage.ServiceContract) *service_manage.Response {
	return svr.nextSvr.DeleteServiceContractInterfaces(ctx, contract)
}

// DeleteServiceContracts implements service.DiscoverServer.
func (svr *Server) DeleteServiceContracts(ctx context.Context, req []*service_manage.ServiceContract) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteServiceContracts(ctx, req)
}

// DeleteServices implements service.DiscoverServer.
func (svr *Server) DeleteServices(ctx context.Context, req []*service_manage.Service) *service_manage.BatchWriteResponse {
	return svr.nextSvr.DeleteServices(ctx, req)
}

// EnableCircuitBreakerRules implements service.DiscoverServer.
func (svr *Server) EnableCircuitBreakerRules(ctx context.Context, request []*fault_tolerance.CircuitBreakerRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.EnableCircuitBreakerRules(ctx, request)
}

// EnableRateLimits implements service.DiscoverServer.
func (svr *Server) EnableRateLimits(ctx context.Context, request []*traffic_manage.Rule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.EnableRateLimits(ctx, request)
}

// EnableRoutings implements service.DiscoverServer.
func (svr *Server) EnableRoutings(ctx context.Context, req []*traffic_manage.RouteRule) *service_manage.BatchWriteResponse {
	return svr.nextSvr.EnableRoutings(ctx, req)
}

// GetAllServices implements service.DiscoverServer.
func (svr *Server) GetAllServices(ctx context.Context, query map[string]string) *service_manage.BatchQueryResponse {
	return svr.nextSvr.GetAllServices(ctx, query)
}

// GetCircuitBreaker implements service.DiscoverServer.
func (svr *Server) GetCircuitBreaker(ctx context.Context, query map[string]string) *service_manage.BatchQueryResponse {
	return svr.nextSvr.GetCircuitBreaker(ctx, query)
}

// GetCircuitBreakerByService implements service.DiscoverServer.
func (svr *Server) GetCircuitBreakerByService(ctx context.Context, query map[string]string) *service_manage.BatchQueryResponse {
	return svr.nextSvr.GetCircuitBreakerByService(ctx, query)
}

// GetCircuitBreakerRules implements service.DiscoverServer.
func (svr *Server) GetCircuitBreakerRules(ctx context.Context, query map[string]string) *service_manage.BatchQueryResponse {
